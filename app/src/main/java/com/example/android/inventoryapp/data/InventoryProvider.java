...
public class InventoryProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case PRODUCTS:
                ...
                break;
            case PRODUCT_ID:
                /* Query for a specific row in the Products table */
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (price == null || price <= 0) {
            throw new IllegalArgumentException("Product requires valid price(>0)");
        }

        // Check that the available quantity is valid
        Integer availableQuantity = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_QUANTITY);
        ...
        // Check that the supplier mail is not null
        String supplierMail = values.getAsString(ProductEntry.COLUMN_PRODUCT_SUPPLIER_MAIL);
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // Check that the supplier mail is not null
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_SUPPLIER_MAIL)) {
            String supplierMail = values.getAsString(ProductEntry.COLUMN_PRODUCT_SUPPLIER_MAIL);
            if (supplierMail == null) {
                throw new IllegalArgumentException("Product requires a supplier mail");
            }
